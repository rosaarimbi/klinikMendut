      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  if($ggl){
                        ...
                        echo "<center>Maaf Data Ini Tidak Tersedia</center>";
                        echo "</div>";
                        echo "</div>";
          ...
          <div class="row justify-content-center">
           ...
           &nbsp;<a href="hapus_pasien.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-danger">  Hapus  </button></a>  
           &nbsp;<a href="edit_pasien.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-success">  Edit  </button></a>  
           <?php 
          }}
           ?>
           </div>
           <div class="col-ml-8 ml-5">
