      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
              <center><h5 class="mb-5"><b>Tambah Obat Medis</b></h5></center>
              ...
              <input class="form-control form-control-sm" type="text" placeholder="Nama Obat Medis..." aria-label=".form-control-sm example" name='nama' required>
              </div>


              <div class="col-sm-4">
            <label>Keterangan Obat Medis:</label>
            <input class="form-control form-control-sm" type="text" placeholder="Keterangan Obat Medis..." aria-label=".form-control-sm example" name='keterangan' required>
            </div>

            <div class="col-sm-4">
            <label>Stock Obat Medis:</label>
            <input class="form-control form-control-sm" type="number" placeholder="Stock Obat Medis..." aria-label=".form-control-sm example" name='jumlah' required>
            </div>
