          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="row mb-4">
                 <div class="col">
                <div class="form-outline">
                  <input class="form-control" type="date" placeholder="TTL" name="ttl" required/>
                </div>
                </div>

                <div class="col">
                  <div class="form-outline">
                    <input class="form-control"  type="number" placeholder="Nomor Handphone" name='nomor' required/>
                  </div>
                </div>
              </div>
...
$nomor = htmlspecialchars($_POST['nomor']);
       ...
       $wet =mysqli_query($conn, "select * from pasien where nopasien ='$nopasien' and nama ='$nama' and ttl ='$ttl' and kelamin='$gander' and nik ='$nik' and alamat='$alamat' and nomor='$nomor'");
       $chak = mysqli_num_rows($wet);
       if($chak > 0){

         $rew = mysqli_fetch_array($wet);
         $nopasien === $rew['nopasien'];
         $nama === $rew['nama'];
         $nik === $rew['nik'];
         $ttl === $rew['ttl'];
         $gander === $rew['kelamin'];
