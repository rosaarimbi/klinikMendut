...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   <h6 class="m-0 font-weight-bold text-primary">Data Tenaga Medis Klinik:</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <?php
           ...
           <h7 class="m-0 font-weight-bold">Kapasitas Tenaga Medis: <?php echo $kap; ?></h7><br>
           <a href="export_medis.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                 ...
                 if(mysqli_num_rows($brg)){
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>&nbsp;<a href="edit_medis.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_medis.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_medis.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
