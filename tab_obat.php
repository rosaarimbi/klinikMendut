    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
           ...
           <h6 class="m-0 font-weight-bold text-primary">Data Stock Obat Klinik:</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                          <?php
                   ...
                   <h7 class="m-0 font-weight-bold">Kapasitas Stock Obat: <?php echo $kap; ?></h7><br>
                   <a href="export_obat.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                         ...
                         if(mysqli_num_rows($brg)){
                           ...
                           <tbody>
                             <tr>
                               ...
                               <td>&nbsp;<a href="edit_obat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_obat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_obat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
