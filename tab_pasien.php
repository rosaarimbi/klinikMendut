           ...
           <!-- <a href="export_pasien.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
                   ...
                   <div class="col-md-4 mt-5 ">
                     <form class="form-inline my-2 my-lg-0" action="cari_pasien.php" method="get" name='cari'>
                           <input class="form-control mr-sm-2" type="search" placeholder="Nama/NIK/No.pasien" aria-label="Search" name='cari'  required>
...
if(isset($_GET['hapus'])){
   ...
   echo "<div>";
   echo "<div class='alert alert-danger mt-4'>";
   echo "<center>Gagal Menghapus</center>";
   echo "</div>";
   echo "</div>";
 }
                   ...
                   if(isset($_GET['cari'])){
                     ...
                     $brg=mysqli_query($conn, "select * from pasien where id like '%".$cari."%' or nama like '%".$cari."%' or nik like '%".$cari."%' or nopasien like '%".$cari."%' ");

                 if(mysqli_num_rows($brg) > 0){
                         echo "<div>";
                         echo "<div class='alert alert-primary mt-4'>";
                         echo "<center>Data Berhasil Ditemukan</center>";
                         echo  "</div>";
                         echo "</div>";
