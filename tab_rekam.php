...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   <h6 class="m-0 font-weight-bold text-primary">Data Rekam Medis Klinik:</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <?php
                 ...
                 if(mysqli_num_rows($brg)){
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>&nbsp;<a href="edit_rekam.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_rekam.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_rekam.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
