        ...
        <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                      <center><h5 class="mb-5"><b>Tambah Tenaga Medis</b></h5></center>
                      ...
                      <input class="form-control form-control-sm" type="text" placeholder="Nama Tenaga Kesehatan..." aria-label=".form-control-sm example" name='nama' required>
                      </div>


                        <div class="col-sm-4">
                          <label>Alamat Tenaga Kesehatan:</label>
                          <input class="form-control form-control-sm" type="text" placeholder="Alamat Tenaga Kesehatan..." aria-label=".form-control-sm example" name='alamat' required>
